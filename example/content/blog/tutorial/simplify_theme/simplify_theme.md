Title: Simplify-Next Theme
Summary: A simple and clean Bootstrap 5 based theme for Pelican users
Author: Name Name
...
A simple, clean, contentful [Bootstrap 5](https://getbootstrap.com/docs/5.3/getting-started/introduction) theme for Pelican blogger.
...
Source code [simplify-theme](https://github.com/Name Name/simplify-theme)
...
Download the theme from [simplify-theme](https://github.com/Name Name/simplify-theme) or from [pelican-themes](https://github.com/getpelican/pelican-themes).
...
This [Simplify-Next Theme Article](https://Name Name.github.io/blog/simplify-article.html) will guide you how to write content in markdown and how it will be rendered on your page.
...
Simplify-Next Theme is released under the [Creative Commons Attribution 4.0 International](https://spdx.org/licenses/CC-BY-4.0.html) license.
